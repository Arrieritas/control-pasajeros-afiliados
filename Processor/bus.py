...
class Bus:
    ...
    def get_passengers(self, passengers_list:list, travels_range_time:list):
        ...
        for i in passengers_list:
            ...
            if i[2] == 2:
                if not(is_range) or (i[6] in black_stations) or (i[5] > 19 or i[4] > 24):
                ...
                if  (i[5] < 20 and i[4] < 25) and (i[6] not in black_stations):
    ...
    def get_number_of_travels(self, travels_data:list):
        ...
        for travel in reversed(travels_data):
            ...
            def myFunct(x):
                if x[0] == travel[0] and str(x[3])[0:10] == date and (x[6] == 'terminalarrieritas') and (travel[5] > 30):
                    return True
                else:
                    return False
            ...
            if (last_terminal == '') and (travel[6] != 'arrieritasws') and (not(travel[0] in metro)) and ((travel[1] != 'Minorista - La 50') and (travel[1] != 'Minorista - Variante')) and (travel[1] != 'Minorista - Tablaza Variante') and (travel[5] > 30):
                jornada = "Mañana" if int(travel[4][11:13].replace(":", "")) < 12 else "Tarde"
            ...
            if travel[6] == last_terminal and ((travel[1] != 'Minorista - La 50') and (travel[1] != 'Minorista - Variante')) and (not(travel[0] in metro)) and (travel[1] != 'Minorista - Tablaza Variante'):
            ...
            travel_time = 0 if travel[5] == 'En progreso' else travel[5]
            ...
            if travel[6] == 'terminalarrieritas':
                ...
                if ('Metro' in travel[1]) or (travel[1] == 'Circular'):
                    ...
                    if travel[1] == 'Variante Miel Metro' and (travel_time > 40):
                        travels[date]["ida"]["vm"] += 1
                        travels[date]["ida"]["total"] += 1
                    if travel[1] == 'Variante tablaza Metro' and (travel_time > 40):
                        travels[date]["ida"]["vt"] += 1
                        travels[date]["ida"]["total"] += 1
                    if travel[1] == 'Metro La 50' and (travel_time > 40):
                        travels[date]["ida"]["c"] += 1
                        travels[date]["ida"]["total"] += 1
                    if travel[1] == 'Circular' and (travel_time > 40):
                        travels[date]["ida"]["cr"] += 1
                        travels[date]["ida"]["total"] += 1
                    
                if travel[1] == 'Caldas - Medellin - Tablaza Variante' and (travel_time > 40):
                    travels[date]["ida"]["vt"] += 1
                    travels[date]["ida"]["total"] += 1
                if travel[1] == 'Caldas - Medellin - Variante' and (travel_time > 40):
                    travels[date]["ida"]["vm"] += 1
                    travels[date]["ida"]["total"] += 1
                if travel[1] == 'Caldas - Medellín - La 50' and (travel_time > 40):
                    travels[date]["ida"]["c"] += 1
                    travels[date]["ida"]["total"] += 1
            ...
            if travel[6] == 'arrieritasws':
                if travel[1] == 'Variante Miel Caldas' and (travel_time > 40):
                    travels[date]["vuelta"]["vm"] += 1
                    travels[date]["vuelta"]["total"] += 1
                if travel[1] == 'Variante Tablaza Caldas' and (travel_time > 40):
                    travels[date]["vuelta"]["vt"] += 1
                    travels[date]["vuelta"]["total"] += 1
                if travel[1] == 'Medellin - Caldas' and (travel_time > 40):
